        ...
        <div class="main">
           ...
           <br>         
                <a href="<?php echo $this->Html->url(array('controller' => "Home", 'action'=>"index" ));?>">
                    <img class="active" src="images/boxx.png" height="234" width="500">
                </a>
            </div>
              </div>
                <ul id="cbp-bislideshow" class="cbp-bislideshow">
                    <li><img src="images/slider/bg6.jpg" alt="image01"/></li>
                    <li><img src="images/slider/bg7.jpg" alt="image02"/></li>
                    <li><img src="images/slider/bg8.jpg" alt="image03"/></li>
                </ul>
